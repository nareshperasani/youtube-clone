...
export const LOAD_PROFILE = 'LOGIN_PROFILE';
...
export const SELECTED_VIDEO_REQUEST = "SELECT_VIDEO_REQUEST";
export const SELECTED_VIDEO_SUCCESS = "SELECT_VIDEO_SUCCESS";
export const SELECTED_VIDEO_FAIL = "SELECT_VIDEO_FAIL";
